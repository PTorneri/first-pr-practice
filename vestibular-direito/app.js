(function () {
  ...
  function renderRedacaoTab() {
    ...
    intro.innerHTML = `
      ...
      <p class="lesson-desc">Texto <strong>dissertativo-argumentativo, em prosa</strong> — e as duas bancas contam
      de um jeito diferente. A <strong>FGV</strong> pede 20 a 30 linhas, com título livre e recomendável. O
      <strong>Insper</strong> pede 10 a 30, apresenta dois temas para escolher um e exige que a questão-tema
      seja copiada como título.</p>
      <p class="hint">Nenhuma das duas exige proposta de intervenção — isso é regra do ENEM. A FGV corrige por
      três quesitos (tema e estrutura; articulação e argumentação; correção gramatical); o Insper, por cinco, e o
      edital dele anula quem monta o texto com modelo pronto de internet. Nas propostas cujo tema é pergunta há
      um botão com o comando do Insper para o mesmo assunto.</p>
  ...
  function renderSyncCard() {
    ...
    wrap.querySelector(".sync-export-btn").addEventListener("click", () => {
      ...
      a.href = url;
      a.download = "sagax-direito-progresso.json";
      a.click();
