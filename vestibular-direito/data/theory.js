...
// Teoria da trilha de Direito, por frente.
...
window.THEORY = {
 ...
 "historia": {
  "resumo": "Do Brasil colonial à redemocratização e da Idade Moderna à Guerra Fria, no mesmo caderno de Ciências Humanas. A banca cobra processo — causa, ruptura e consequência —, não data isolada.",
  "gatilhos": [
 ...
 "atualidades": {
  "resumo": "Política e economia do Brasil, geopolítica, meio ambiente e tecnologia. É a área que envelhece mais rápido do banco: a FGV fecha o caderno com fonte de um a três meses antes da prova, e o que se cobra é leitura recente, não memória.",
  "gatilhos": [
