...
// Subtemas da trilha de Economia.
...
window.SUBTOPICS = [
  {
    ...
    "buscaVideo": [
      "aula geometria plana espacial vestibular",
      "geometria analítica trigonometria vestibular"
    ]
  },
  {
    ...
    "area": "Matemática",
    "areaGrande": "Matemática",
    "nome": "Estatística, Porcentagem e Proporção",
    ...
    "buscaVideo": [
      "aula porcentagem juros compostos vestibular",
      "média mediana desvio padrão vestibular"
    ]
  },
  {
    ...
    "area": "Matemática",
    "areaGrande": "Matemática",
    "nome": "Álgebra, Funções e Matrizes",
    ...
    "buscaVideo": [
      "aula função afim quadrática vestibular",
      "logaritmo exponencial matrizes vestibular"
    ]
  },
  {
    ...
    "buscaVideo": [
      "aula probabilidade vestibular",
      "análise combinatória vestibular"
    ]
  },
  {
    ...
    "area": "Matemática",
    "areaGrande": "Matemática",
    "nome": "Sequências e Recorrências",
    ...
    "buscaVideo": [
      "aula progressão aritmética geométrica vestibular",
      "sequências e recorrências vestibular"
    ]
  },
  {
  ...
  },
  {
    ...
    "areaGrande": "Linguagens",
    "nome": "Argumentação e Ponto de Vista",
    "descricao": "Argumento, contra-argumento, estratégia argumentativa, falácia e a distinção entre fato e opinião.",
    "buscaVideo": [
      "aula estrutura argumentativa vestibular",
      "fato e opinião falácias vestibular"
    ]
  },
  {
    "id": "interpretacao-inferencia",
    "frenteId": "interpretacao-texto",
    "area": "Interpretação de Texto",
    "areaGrande": "Linguagens",
    "nome": "Inferência e Pressuposto",
    "descricao": "O que o texto autoriza concluir sem dizer com todas as letras: pressuposto, subentendido e inferência.",
    "buscaVideo": [
      "aula inferência pressuposto subentendido vestibular",
      "interpretação implícito vestibular"
    ]
  },
  {
    "id": "interpretacao-genero-discurso",
    "frenteId": "interpretacao-texto",
    "area": "Interpretação de Texto",
    "areaGrande": "Linguagens",
    "nome": "Gênero Textual e Discurso",
    "descricao": "Gênero textual, suporte, interlocutor, narrador, discurso direto e indireto e intertextualidade.",
    "buscaVideo": [
      "aula gêneros textuais vestibular",
      "discurso direto indireto narrador vestibular"
    ]
  },
  {
    "id": "interpretacao-recursos-linguagem",
    "frenteId": "interpretacao-texto",
    "area": "Interpretação de Texto",
    "areaGrande": "Linguagens",
    "nome": "Recursos Expressivos e Linguagem",
    "descricao": "Figuras de linguagem, ironia, conotação, tom e registro. É onde a leitura literal erra a questão.",
    "buscaVideo": [
      "aula figuras de linguagem vestibular",
      "ironia conotação registro linguístico vestibular"
    ]
  },
  {
    "id": "interpretacao-estrutura-coesao",
    "frenteId": "interpretacao-texto",
    "area": "Interpretação de Texto",
    "areaGrande": "Linguagens",
    "nome": "Estrutura Textual e Progressão",
    "descricao": "Progressão entre parágrafos, conectivos, retomada e relações de causa, oposição e conclusão.",
    "buscaVideo": [
      "aula coesão textual conectivos vestibular",
      "progressão temática estrutura do texto vestibular"
    ]
  },
  {
    "id": "interpretacao-ideia-central",
    "frenteId": "interpretacao-texto",
    "area": "Interpretação de Texto",
    "areaGrande": "Linguagens",
    "nome": "Ideia Central e Síntese",
    "descricao": "Tese, tema, síntese e melhor título. A pergunta mais frequente de toda prova de Linguagens.",
    "buscaVideo": [
      "aula ideia central do texto vestibular",
      "como identificar a tese do texto vestibular"
    ]
  },
  {
    "id": "gramatica-coesao-semantica",
    "frenteId": "gramatica",
    "area": "Gramática e Norma Culta",
    "areaGrande": "Linguagens",
    "nome": "Coesão, Coerência e Semântica",
    "descricao": "Coesão, conectivos, retomada, sinonímia, ambiguidade, variação linguística e reescrita sem mudar o sentido.",
    "buscaVideo": [
      "aula coesão coerência conectivos vestibular",
      "reescrita de frases variação linguística vestibular"
    ]
  },
  {
    "id": "gramatica-regencia-crase",
    "frenteId": "gramatica",
    "area": "Gramática e Norma Culta",
    "areaGrande": "Linguagens",
    ...
    "buscaVideo": [
      "aula regência verbal nominal vestibular",
      "crase regra prática vestibular"
    ]
  },
  {
    "id": "gramatica-concordancia",
    "frenteId": "gramatica",
    "area": "Gramática e Norma Culta",
    "areaGrande": "Linguagens",
    "nome": "Concordância",
    ...
    "buscaVideo": [
      "aula concordância verbal nominal vestibular",
      "sujeito composto verbo impessoal vestibular"
    ]
  },
  {
    "id": "gramatica-morfologia",
    "frenteId": "gramatica",
    "area": "Gramática e Norma Culta",
    "areaGrande": "Linguagens",
    "nome": "Classes de Palavras e Morfologia",
    "descricao": "Classes de palavras, pronomes e colocação pronominal, tempos e modos verbais, formação de palavras e acentuação.",
    "buscaVideo": [
      "aula classes de palavras morfologia vestibular",
      "colocação pronominal acentuação vestibular"
    ]
  },
  {
    "id": "gramatica-pontuacao",
    "frenteId": "gramatica",
    "area": "Gramática e Norma Culta",
    "areaGrande": "Linguagens",
    "nome": "Pontuação",
    ...
    "buscaVideo": [
      "aula pontuação vírgula vestibular",
      "oração adjetiva explicativa restritiva vestibular"
    ]
  },
  {
    "id": "gramatica-sintaxe-periodo",
    "frenteId": "gramatica",
    "area": "Gramática e Norma Culta",
    "areaGrande": "Linguagens",
    "nome": "Sintaxe e Estrutura do Período",
    "descricao": "Análise sintática, período composto, orações subordinadas e coordenadas, funções sintáticas e vozes verbais.",
    "buscaVideo": [
      "aula análise sintática período composto vestibular",
      "orações subordinadas coordenadas vestibular"
    ]
  },
  {
    "id": "literatura-realismo-naturalismo",
    "frenteId": "literatura",
    "area": "Literatura Brasileira",
    "areaGrande": "Linguagens",
    "nome": "Realismo, Naturalismo, Parnasianismo e Simbolismo",
    "descricao": "Realismo, Naturalismo, Parnasianismo, Simbolismo e Pré-Modernismo. Machado e Aluísio dominam o subtema.",
    "buscaVideo": [
      "aula realismo naturalismo machado de assis vestibular",
      "pré-modernismo os sertões vestibular"
    ]
  },
  {
    "id": "literatura-colonial-romantismo",
    "frenteId": "literatura",
    "area": "Literatura Brasileira",
    "areaGrande": "Linguagens",
    "nome": "Do Barroco ao Romantismo",
    "descricao": "Quinhentismo, Barroco, Arcadismo e Romantismo: de Gregório de Matos a Alencar, Gonçalves Dias e Castro Alves.",
    "buscaVideo": [
      "aula barroco arcadismo vestibular",
      "romantismo brasileiro alencar vestibular"
    ]
  },
  {
    ...
    "buscaVideo": [
      "aula modernismo semana de 22 vestibular",
      "geração de 30 graciliano drummond vestibular"
    ]
  },
  {
    "id": "literatura-teoria-analise",
    "frenteId": "literatura",
    "area": "Literatura Brasileira",
    "areaGrande": "Linguagens",
    "nome": "Teoria Literária e Análise",
    ...
    "buscaVideo": [
      "aula análise de poema métrica rima vestibular",
      "foco narrativo tipos de narrador vestibular"
    ]
  },
  {
    ...
    "buscaVideo": [
      "aula clarice lispector guimarães rosa vestibular",
      "literatura contemporânea brasileira vestibular"
    ]
  },
  {
    "id": "ingles-inference",
    ...
    "buscaVideo": [
      "reading comprehension inference vestibular",
      "inferência em texto de inglês vestibular"
    ]
  },
  {
    "id": "ingles-grammar-structure",
    "frenteId": "ingles",
    "area": "Língua Inglesa",
    "areaGrande": "Linguagens",
    "nome": "Grammar and Text Structure",
    "descricao": "Tempos verbais, conectivos, voz passiva e como o texto se organiza de um parágrafo ao seguinte.",
    "buscaVideo": [
      "aula tempos verbais inglês vestibular",
      "linking words connectors inglês vestibular"
    ]
  },
  {
    "id": "ingles-main-idea",
  ...
  },
  {
    ...
    "area": "Língua Inglesa",
    "areaGrande": "Linguagens",
    "nome": "Vocabulary in Context",
    "descricao": "Vocabulário em contexto, sinônimos e a que palavra o pronome se refere. Dá para acertar sem conhecer o termo.",
    "buscaVideo": [
      "vocabulary in context vestibular",
      "referência pronominal texto em inglês vestibular"
    ]
  },
  {
    "id": "historia-brasil-colonia-imperio",
    "frenteId": "historia",
    "area": "História",
    "areaGrande": "Ciências Humanas",
    ...
    "buscaVideo": [
      "aula brasil colônia vestibular",
      "primeiro segundo reinado abolição vestibular"
    ]
  },
  {
    "id": "historia-brasil-republica",
    "frenteId": "historia",
    "area": "História",
    "areaGrande": "Ciências Humanas",
    ...
    "buscaVideo": [
      "aula república velha era vargas vestibular",
      "ditadura militar redemocratização vestibular"
    ]
  },
  {
    ...
    "buscaVideo": [
      "aula guerras mundiais vestibular",
      "guerra fria descolonização vestibular"
    ]
  },
  {
    "id": "historia-geral-moderna",
    "frenteId": "historia",
    "area": "História",
    "areaGrande": "Ciências Humanas",
    "nome": "Idade Moderna",
    ...
    "buscaVideo": [
      "aula absolutismo mercantilismo vestibular",
      "revolução francesa iluminismo vestibular"
    ]
  },
  {
    "id": "historia-geral-antiga-medieval",
    "frenteId": "historia",
    "area": "História",
    "areaGrande": "Ciências Humanas",
    "nome": "Antiguidade e Idade Média",
    ...
    "buscaVideo": [
      "aula grécia roma antiga vestibular",
      "feudalismo idade média vestibular"
    ]
  },
  {
    "id": "geografia-populacao-urbana",
    "frenteId": "geografia",
    "area": "Geografia",
    "areaGrande": "Ciências Humanas",
    "nome": "População e Espaço Urbano",
    "descricao": "Demografia, transição demográfica, migrações, urbanização, metrópoles e desigualdade no espaço da cidade.",
    "buscaVideo": [
      "aula demografia transição demográfica vestibular",
      "urbanização metrópoles vestibular"
    ]
  },
  {
    "id": "geografia-fisica-clima",
    "frenteId": "geografia",
    "area": "Geografia",
    "areaGrande": "Ciências Humanas",
    "nome": "Geografia Física e Clima",
    "descricao": "Clima, relevo, solos, vegetação, hidrografia e dinâmica interna da Terra. O maior subtema de Geografia no banco.",
    "buscaVideo": [
      "aula climatologia relevo vestibular",
      "biomas hidrografia do brasil vestibular"
    ]
  },
  {
    "id": "geografia-agraria-economica",
    "frenteId": "geografia",
    "area": "Geografia",
    "areaGrande": "Ciências Humanas",
    "nome": "Agricultura, Indústria e Energia",
    "descricao": "Estrutura fundiária, agronegócio, agricultura familiar, indústria, mineração e matriz energética.",
    "buscaVideo": [
      "aula geografia agrária estrutura fundiária vestibular",
      "industrialização matriz energética brasil vestibular"
    ]
  },
  {
    "id": "geografia-geopolitica",
    "frenteId": "geografia",
    "area": "Geografia",
    "areaGrande": "Ciências Humanas",
    "nome": "Geopolítica e Globalização",
    ...
    "buscaVideo": [
      "aula geopolítica ordem mundial vestibular",
      "blocos econômicos globalização vestibular"
    ]
  },
  {
    "id": "geografia-ambiente-sustentabilidade",
    "frenteId": "geografia",
    "area": "Geografia",
    "areaGrande": "Ciências Humanas",
    "nome": "Questão Ambiental",
    ...
    "buscaVideo": [
      "aula questão ambiental vestibular",
      "mudanças climáticas sustentabilidade vestibular"
    ]
  },
  {
    "id": "geografia-cartografia",
    "frenteId": "geografia",
    "area": "Geografia",
    "areaGrande": "Ciências Humanas",
    "nome": "Cartografia e Representação",
    "descricao": "Mapas, escalas, projeções, coordenadas, fusos e sensoriamento remoto. Questão de leitura, não de memória.",
    "buscaVideo": [
      "aula cartografia escalas projeções vestibular",
      "coordenadas geográficas fusos horários vestibular"
    ]
  },
  {
    "id": "filosofia-politica",
    "frenteId": "filosofia-sociologia",
    "area": "Filosofia e Sociologia",
    "areaGrande": "Ciências Humanas",
    "nome": "Filosofia Política e Estado",
    "descricao": "Contratualismo, Estado, democracia, liberdade e poder. De Hobbes e Rousseau a Arendt e Foucault.",
    "buscaVideo": [
      "aula contratualismo hobbes locke rousseau vestibular",
      "filosofia política democracia poder vestibular"
    ]
  },
  {
    "id": "filosofia-etica-moral",
    "frenteId": "filosofia-sociologia",
    "area": "Filosofia e Sociologia",
    "areaGrande": "Ciências Humanas",
    "nome": "Ética e Moral",
    ...
    "buscaVideo": [
      "aula ética filosofia vestibular",
      "kant utilitarismo justiça vestibular"
    ]
  },
  {
    "id": "sociologia-trabalho-classes",
    "frenteId": "filosofia-sociologia",
    "area": "Filosofia e Sociologia",
    "areaGrande": "Ciências Humanas",
    "nome": "Trabalho, Classes e Capitalismo",
    "descricao": "Marx, Durkheim e Weber, capitalismo, divisão do trabalho, desigualdade e as formas recentes de precarização.",
    "buscaVideo": [
      "aula marx durkheim weber vestibular",
      "trabalho e desigualdade sociologia vestibular"
    ]
  },
  {
    "id": "sociologia-cultura-identidade",
    "frenteId": "filosofia-sociologia",
    "area": "Filosofia e Sociologia",
    "areaGrande": "Ciências Humanas",
    "nome": "Cultura, Identidade e Mídia",
    "descricao": "Cultura, etnocentrismo, identidade, indústria cultural, mídia e redes. Onde a prova encontra o presente.",
    "buscaVideo": [
      "aula cultura identidade sociologia vestibular",
      "indústria cultural redes sociais vestibular"
    ]
  },
  {
    "id": "filosofia-conhecimento-logica",
    "frenteId": "filosofia-sociologia",
    "area": "Filosofia e Sociologia",
    "areaGrande": "Ciências Humanas",
    "nome": "Conhecimento, Lógica e Ciência",
    "descricao": "Teoria do conhecimento, racionalismo e empirismo, lógica e argumentação, e filosofia da ciência.",
    "buscaVideo": [
      "aula teoria do conhecimento vestibular",
      "lógica argumentação falácias vestibular"
    ]
  },
  {
    "id": "sociologia-instituicoes-movimentos",
    "frenteId": "filosofia-sociologia",
    "area": "Filosofia e Sociologia",
    "areaGrande": "Ciências Humanas",
    "nome": "Instituições e Movimentos Sociais",
    "descricao": "Instituições, cidadania, movimentos sociais, políticas públicas e ação coletiva. Banco curto.",
    "buscaVideo": [
      "aula movimentos sociais cidadania vestibular",
      "instituições sociais políticas públicas vestibular"
    ]
  },
  {
    "id": "dh-fundamentos",
    "frenteId": "direitos-humanos",
    "area": "Direitos Humanos e Cidadania",
    "areaGrande": "Ciências Humanas",
    ...
    "buscaVideo": [
      "aula direitos humanos fundamentos vestibular",
      "declaração universal gerações de direitos vestibular"
    ]
  },
  {
    "id": "dh-constitucional",
    "frenteId": "direitos-humanos",
    "area": "Direitos Humanos e Cidadania",
    "areaGrande": "Ciências Humanas",
    "nome": "Constituição e Estado Democrático",
    "descricao": "Constituição de 1988, direitos fundamentais, separação dos poderes e remédios constitucionais.",
    "buscaVideo": [
      "aula constituição de 1988 direitos fundamentais vestibular",
      "remédios constitucionais habeas corpus vestibular"
    ]
  },
  {
    "id": "dh-igualdade-discriminacao",
    "frenteId": "direitos-humanos",
    "area": "Direitos Humanos e Cidadania",
    "areaGrande": "Ciências Humanas",
    "nome": "Igualdade e Não Discriminação",
    "descricao": "Discriminação, racismo, gênero, ações afirmativas e proteção de grupos vulneráveis.",
    "buscaVideo": [
      "aula igualdade e discriminação direitos humanos vestibular",
      "ações afirmativas cotas vestibular"
    ]
  },
  {
    "id": "dh-direitos-sociais",
    "frenteId": "direitos-humanos",
    "area": "Direitos Humanos e Cidadania",
    "areaGrande": "Ciências Humanas",
    "nome": "Direitos Sociais e Políticas Públicas",
    "descricao": "Saúde, educação, moradia, trabalho digno e as políticas públicas que os concretizam.",
    "buscaVideo": [
      "aula direitos sociais políticas públicas vestibular",
      "mínimo existencial reserva do possível vestibular"
    ]
  },
  {
    "id": "dh-justica-seguranca",
    "frenteId": "direitos-humanos",
    "area": "Direitos Humanos e Cidadania",
    "areaGrande": "Ciências Humanas",
    "nome": "Justiça, Segurança e Cidadania",
    "descricao": "Sistema penal, encarceramento, violência institucional, acesso à justiça e liberdade de expressão.",
    "buscaVideo": [
      "aula sistema penal encarceramento direitos humanos vestibular",
      "acesso à justiça liberdade de expressão vestibular"
    ]
  },
  {
    "id": "artes-classica-moderna",
    "frenteId": "artes-cultura",
    "area": "Artes e Cultura",
    "areaGrande": "Ciências Humanas",
    "nome": "Arte Clássica e Moderna",
    "descricao": "Do Renascimento às vanguardas e ao modernismo brasileiro, incluindo arquitetura — das ordens gregas a Niemeyer.",
    "buscaVideo": [
      "aula história da arte renascimento vanguardas vestibular",
      "modernismo brasileiro tarsila portinari vestibular"
    ]
  },
  {
    "id": "artes-audiovisual-midia",
    "frenteId": "artes-cultura",
    "area": "Artes e Cultura",
    "areaGrande": "Ciências Humanas",
    "nome": "Cinema, Fotografia e Audiovisual",
    "descricao": "Cinema, fotografia, videoarte e a reprodutibilidade técnica da imagem. Cinema Novo é presença constante.",
    "buscaVideo": [
      "aula história do cinema brasileiro vestibular",
      "fotografia reprodutibilidade técnica benjamin vestibular"
    ]
  },
  {
    "id": "artes-patrimonio-cultura-popular",
    "frenteId": "artes-cultura",
    "area": "Artes e Cultura",
    "areaGrande": "Ciências Humanas",
    "nome": "Patrimônio e Cultura Popular",
    "descricao": "Patrimônio material e imaterial, cultura popular, arte indígena e afro-brasileira. Banco curto.",
    "buscaVideo": [
      "aula patrimônio cultural imaterial vestibular",
      "arte indígena afro-brasileira vestibular"
    ]
  },
  {
    "id": "artes-musica-cena",
    "frenteId": "artes-cultura",
    "area": "Artes e Cultura",
    "areaGrande": "Ciências Humanas",
    "nome": "Música, Teatro e Dança",
    "descricao": "Música erudita e popular brasileira, teatro, dança e as artes do palco.",
    "buscaVideo": [
      "aula história da música brasileira vestibular",
      "teatro e dança história da arte vestibular"
    ]
  },
  {
    "id": "artes-contemporanea",
    "frenteId": "artes-cultura",
    "area": "Artes e Cultura",
    "areaGrande": "Ciências Humanas",
    ...
    "buscaVideo": [
      "aula arte contemporânea vestibular",
      "lygia clark hélio oiticica neoconcretismo vestibular"
    ]
  },
  {
    "id": "atualidades-politica-economia",
    "frenteId": "atualidades",
    "area": "Atualidades",
    "areaGrande": "Atualidades",
    "nome": "Política e Economia do Brasil",
    "descricao": "Conjuntura brasileira: instituições, reformas, inflação, juros e orçamento público.",
    "buscaVideo": [
      "atualidades política economia brasil resumo",
      "conjuntura econômica brasileira atualidades vestibular"
    ]
  },
  {
    ...
    "area": "Atualidades",
    "areaGrande": "Atualidades",
    "nome": "Geopolítica e Relações Internacionais",
    "descricao": "Conflitos, blocos, organismos multilaterais e disputa entre potências. O maior subtema de Atualidades.",
    "buscaVideo": [
      "atualidades geopolítica conflitos resumo",
      "relações internacionais atualidades vestibular"
    ]
  },
  {
    ...
    "area": "Atualidades",
    "areaGrande": "Atualidades",
    "nome": "Meio Ambiente e Clima",
    "descricao": "Clima, COPs, transição energética, desmatamento e eventos extremos. Envelhece rápido: prefira fonte recente.",
    "buscaVideo": [
      "atualidades meio ambiente clima resumo",
      "COP transição energética atualidades vestibular"
    ]
  },
  {
    "id": "atualidades-tecnologia",
    "frenteId": "atualidades",
    "area": "Atualidades",
    "areaGrande": "Atualidades",
    ...
    "buscaVideo": [
      "atualidades inteligência artificial sociedade resumo",
      "regulação das plataformas dados atualidades vestibular"
    ]
  },
  {
    "id": "atualidades-sociedade-educacao",
    "frenteId": "atualidades",
    "area": "Atualidades",
    "areaGrande": "Atualidades",
    "nome": "Sociedade, Trabalho e Educação",
    "descricao": "Educação, desigualdade, mercado de trabalho, moradia e segurança pública. Repertório direto para a redação.",
    "buscaVideo": [
      "atualidades educação desigualdade resumo",
      "temas sociais para redação atualidades vestibular"
    ]
  },
  {
    "id": "atualidades-saude",
    "frenteId": "atualidades",
    "area": "Atualidades",
    "areaGrande": "Atualidades",
    "nome": "Saúde Pública",
    ...
    "buscaVideo": [
      "atualidades saúde pública SUS resumo",
      "saúde mental epidemias atualidades vestibular"
    ]
  },
  {
    ...
    "nome": "Citologia e Metabolismo Celular",
    ...
    "buscaVideo": [
      "aula citologia organelas vestibular",
      "fotossíntese respiração celular vestibular"
    ]
  },
  {
    ...
    "area": "Biologia",
    "areaGrande": "Ciências da Natureza",
    "nome": "Genética e Hereditariedade",
    ...
    "buscaVideo": [
      "aula genética vestibular",
      "heredograma herança ligada ao sexo vestibular"
    ]
  },
  {
    "id": "biologia-diversidade",
    "frenteId": "biologia",
    "area": "Biologia",
    "areaGrande": "Ciências da Natureza",
    "nome": "Diversidade dos Seres Vivos",
    ...
    "buscaVideo": [
      "aula reinos classificação seres vivos vestibular",
      "botânica zoologia vestibular"
    ]
  },
  {
    "id": "biologia-fisiologia",
    "frenteId": "biologia",
    "area": "Biologia",
    "areaGrande": "Ciências da Natureza",
    ...
    "buscaVideo": [
      "aula fisiologia humana vestibular",
      "sistema circulatório endócrino imunológico vestibular"
    ]
  },
  {
    ...
    "buscaVideo": [
      "aula ecologia vestibular",
      "ciclos biogeoquímicos cadeia alimentar vestibular"
    ]
  },
  {
    "id": "biologia-evolucao",
    "frenteId": "biologia",
    "area": "Biologia",
    "areaGrande": "Ciências da Natureza",
    "nome": "Evolução e Origem da Vida",
    ...
    "buscaVideo": [
      "aula evolução seleção natural vestibular",
      "evidências da evolução origem da vida vestibular"
    ]
  },
  {
    "id": "quimica-eletroquimica",
    "frenteId": "quimica",
    "area": "Química",
    "areaGrande": "Ciências da Natureza",
    "nome": "Eletroquímica e Oxirredução",
    "descricao": "Pilhas, eletrólise, oxirredução, nox e corrosão. Reconhecer quem oxida e quem reduz resolve a maioria das questões.",
    "buscaVideo": [
      "aula eletroquímica pilhas eletrólise vestibular",
      "oxirredução nox vestibular"
    ]
  },
  {
    "id": "quimica-atomistica-ligacoes",
    "frenteId": "quimica",
    "area": "Química",
    "areaGrande": "Ciências da Natureza",
    "nome": "Atomística, Tabela Periódica e Ligações",
    ...
    "buscaVideo": [
      "aula tabela periódica ligações químicas vestibular",
      "geometria molecular polaridade vestibular"
    ]
  },
  {
    "id": "quimica-equilibrio-acido-base",
    "frenteId": "quimica",
    "area": "Química",
    "areaGrande": "Ciências da Natureza",
    "nome": "Equilíbrio, Ácidos e Bases",
    ...
    "buscaVideo": [
      "aula equilíbrio químico Le Chatelier vestibular",
      "pH ácido base hidrólise vestibular"
    ]
  },
  {
    "id": "quimica-organica",
    ...
    "buscaVideo": [
      "aula química orgânica funções vestibular",
      "isomeria polímeros vestibular"
    ]
  },
  {
    "id": "quimica-solucoes",
    ...
    "area": "Química",
    "areaGrande": "Ciências da Natureza",
    "nome": "Soluções e Propriedades Coligativas",
    ...
    "buscaVideo": [
      "aula soluções concentração molaridade vestibular",
      "propriedades coligativas vestibular"
    ]
  },
  {
  ...
  },
  {
    ...
    "area": "Química",
    "areaGrande": "Ciências da Natureza",
    "nome": "Termoquímica e Cinética",
    "descricao": "Entalpia, exo e endotérmica, lei de Hess, velocidade de reação e catalisador. Muito gráfico de energia para ler.",
    "buscaVideo": [
      "aula termoquímica entalpia lei de Hess vestibular",
      "cinética química velocidade de reação vestibular"
    ]
  },
  {
    "id": "fisica-mecanica",
  ...
  {
    "id": "fisica-ondas-optica",
    "frenteId": "fisica",
    "area": "Física",
    "areaGrande": "Ciências da Natureza",
    "nome": "Ondas, Som e Óptica",
    ...
    "buscaVideo": [
      "aula ondulatória som vestibular",
      "óptica espelhos lentes refração vestibular"
    ]
  },
  {
    "id": "fisica-eletromagnetismo",
    "frenteId": "fisica",
    "area": "Física",
    "areaGrande": "Ciências da Natureza",
    ...
    "buscaVideo": [
      "aula eletrodinâmica circuitos vestibular",
      "eletrostática campo magnético indução vestibular"
    ]
  },
  {
    "id": "fisica-hidrostatica",
    "frenteId": "fisica",
    "area": "Física",
    "areaGrande": "Ciências da Natureza",
    "nome": "Hidrostática e Fluidos",
    ...
    "buscaVideo": [
      "aula hidrostática pressão empuxo vestibular",
      "princípio de Arquimedes Pascal vestibular"
    ]
  },
  {
    "id": "fisica-energia-trabalho",
    "frenteId": "fisica",
    "area": "Física",
    "areaGrande": "Ciências da Natureza",
    "nome": "Trabalho, Energia e Momento",
